...
(function () {
  ...
  const THEMES = [
    ...
    { id: 'catppuccin-latte',    label: 'Catppuccin Latte', group: 'Catppuccin', mermaid: 'default' },
    { id: 'catppuccin-frappe',   label: 'Catppuccin Frappé', group: 'Catppuccin', mermaid: 'dark' },
    { id: 'catppuccin-macchiato',label: 'Catppuccin Macchiato', group: 'Catppuccin', mermaid: 'dark' },
    { id: 'catppuccin-mocha',    label: 'Catppuccin Mocha', group: 'Catppuccin', mermaid: 'dark' },
    { id: 'tokyo-night',         label: 'Tokyo Night', group: 'Tokyo Night', mermaid: 'dark' },
    { id: 'tokyo-night-storm',   label: 'Tokyo Night Storm', group: 'Tokyo Night', mermaid: 'dark' },
    { id: 'tokyo-night-day',     label: 'Tokyo Night Day', group: 'Tokyo Night', mermaid: 'default' },
    { id: 'dracula',             label: 'Dracula', group: 'Popular', mermaid: 'dark' },
    { id: 'nord',                label: 'Nord', group: 'Popular', mermaid: 'dark' },
    { id: 'gruvbox-dark',        label: 'Gruvbox Dark', group: 'Gruvbox', mermaid: 'dark' },
    { id: 'gruvbox-light',       label: 'Gruvbox Light', group: 'Gruvbox', mermaid: 'default' },
  ];
  ...
  function setMermaidTheme(theme) {
    ...
    try { mermaid.initialize({ startOnLoad: false, securityLevel: 'loose', theme }); } catch (e) { /* noop */ }
  }
